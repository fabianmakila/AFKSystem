...
public final class TranslationManager {
    ...
    public TranslationManager(AFKSystem plugin) {
        this.plugin = plugin;
        this.logger = plugin.getSLF4JLogger();
        this.localeDirectoryPath = plugin.getDataPath().resolve("locale");
    }
    ...
    public void load() {
        ...
        this.store.defaultLocale(this.plugin.config().defaultLocale());
